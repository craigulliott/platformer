...
has_children: false
has_toc: false
permalink: /models/fields/boolean_field
---

# Boolean Field
{: .no_toc }

Add a boolean field to this model.
...
class MyModel < PlatformModel
  ...
  boolean_field :value, array: false
end
```

#### Boolean Field Arguments
{: .no_toc }

| Name | Required | Type | Description |
|:---|:---|:---|:---|
| name | required | Symbol | The name of this boolean field |
| array | optional | Boolean | If true, then this field will be an array of booleans, and will be backed by a `bool[]` type in PostgreSQL. |

## Additional Configuration
{: .no_toc }

You can further configure the Boolean Field by using the following methods:
...
class MyModel < PlatformModel
  boolean_field :value do
    ...
    validate_is_true 
    # all possible arguments
    validate_is_true message: "message", comment: "comment"
    ...
  end
end
```

#### Validate Is True Arguments
{: .no_toc }
...
class MyModel < PlatformModel
  boolean_field :value do
    ...
    validate_is_false 
    # all possible arguments
    validate_is_false message: "message", comment: "comment"
    ...
  end
end
```

#### Validate Is False Arguments
{: .no_toc }
