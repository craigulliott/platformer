...
class MyModel < PlatformModel
  ...
  country_field prefix: :value, array: false
end
```

#### Country Field Arguments
{: .no_toc }
...
| array | optional | Boolean | If true, then this field will be an array of countrys, and will be backed by a `platformer.countrys[]` type in PostgreSQL. |

## Additional Configuration
{: .no_toc }

You can further configure the Country Field by using the following methods:
