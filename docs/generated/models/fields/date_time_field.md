...
has_children: false
has_toc: false
permalink: /models/fields/date_time_field
---
...
class MyModel < PlatformModel
  ...
  date_time_field :value, array: false
end
```

#### Date Time Field Arguments
{: .no_toc }

| Name | Required | Type | Description |
|:---|:---|:---|:---|
| name | required | Symbol | The name of your field. |
| array | optional | Boolean | If true, then this field will be an array of timestamps, and will be backed by a `timestamp[]` type in PostgreSQL. |

## Additional Configuration
{: .no_toc }

You can further configure the Date Time Field by using the following methods:
