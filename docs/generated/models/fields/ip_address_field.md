...
has_children: false
has_toc: false
permalink: /models/fields/ip_address_field
---
...
class MyModel < PlatformModel
  ...
  ip_address_field :value
  # all possible arguments
  ip_address_field :value, array: false
end
```

#### Ip Address Field Arguments
{: .no_toc }

| Name | Required | Type | Description |
|:---|:---|:---|:---|
| name | required | Symbol | The name of your field. |
| array | optional | Boolean | If true, then this field will be an array of inets, and will be backed by a `inet[]` type in PostgreSQL. |

## Additional Configuration
{: .no_toc }

You can further configure the Ip Address Field by using the following methods:
