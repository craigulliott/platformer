      ...
      module Associations
        class HasMany < DSLCompose::Parser
          ...
          for_children_of PlatformModel do |child_class:|
            ...
            for_dsl_or_inherited_dsl :has_many do |foreign_model:, local_column_names:, foreign_column_names:|
              ...
              model.has_many association_name, class_name: foreign_model.active_record_class.name
            end
          end
        end
      end
