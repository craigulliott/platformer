      ...
      module Schema
        module Queries
          ...
          class RootNode < Parsers::Schemas
            ...
            for_dsl :root_node do |schema_reader:, model_reader:, reader:, model_definition_class:, graphql_type_class:, active_record_class:|
              # the graphql field name, such as `user` or `users_avatar`
              field_name = model_reader.public_name
