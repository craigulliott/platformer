      ...
      module Associations
        class BelongsTo < DSLCompose::Parser
          ...
          for_final_children_of PlatformModel do |child_class:|
            ...
            for_dsl_or_inherited_dsl :belongs_to do |foreign_model:, local_column_names:, foreign_column_names:, comment:, deferrable:, initially_deferred:, on_delete:, on_update:|
