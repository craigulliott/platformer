    ...
    module Migrations
      module Associations
        class HasOne < Parsers::FinalModels
          for_dsl :has_one do |child_class:, dsl_name:, foreign_model:, local_column_names:, foreign_column_names:, comment:, deferrable:, initially_deferred:, on_delete:, on_update:|
