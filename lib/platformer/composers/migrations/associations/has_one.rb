module Platformer
  module Composers
    module Migrations
      module Associations
        # a shared composer for has_one or has_one
        class HasOne < DSLCompose::Parser
          ...
          for_final_children_of PlatformModel do |child_class:|
            ...
            for_dsl_or_inherited_dsl :has_one do |dsl_name:, foreign_model:, local_column_names:, foreign_column_names:, comment:, deferrable:, initially_deferred:, on_delete:, on_update:|
