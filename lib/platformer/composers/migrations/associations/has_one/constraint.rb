      ...
      module Associations
        module HasOne
          class Constraint < Parsers::Models
            for_dsl :has_one do |is_sti_class:, model_definition_class:, module_name:, name:, model:, through:, allow_null:, local_columns:, foreign_columns:, description:, deferrable:, initially_deferred:, on_delete:, on_update:|
              if is_sti_class
