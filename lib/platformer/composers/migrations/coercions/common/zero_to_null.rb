        ...
        module Common
          ...
          class ZeroToNull < Parsers::FinalModels::ForFields
            for_numeric_fields do |name:, table:, array:, description:, allow_null:|
              ...
              for_method :zero_to_null do |method_name:, description:|
                ...
                final_description = description || Databases::Migrations::Templates::Validations::ZeroNulled::DEFAULT_DESCRIPTION
                ...
                table.add_validation validation_name, [column.name], check_clause, template: :zero_nulled, description: final_description
              end
            end
          end
        end
