  ...
  module Composers
    module Migrations
      module Columns
        ...
        class CitextColumns < DSLCompose::Parser
          ...
          for_final_children_of PlatformModel do |child_class:|
            ...
            # for each time the :citext_field DSL was used on this Model
            for_dsl_or_inherited_dsl :citext_field do |name:, array:, reader:|
