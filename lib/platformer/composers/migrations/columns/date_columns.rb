  ...
  module Composers
    module Migrations
      module Columns
        ...
        class DateColumns < DSLCompose::Parser
          ...
          for_final_children_of PlatformModel do |child_class:|
            ...
            # for each time the :date_field DSL was used on this Model
            for_dsl_or_inherited_dsl :date_field do |name:, array:, reader:|
              # update the dynamic documentation
              description <<~DESCRIPTION
                Update DynamicMigrations and add an #{array ? "array of dates" : "date"}
