        ...
        module Triggers
          module Immutable
            def immutable table_name, column_names
              ...
              before_update table_name, name: :immutable, function_schema_name: :platformer, function_name: :validations_immutable, action_condition: action_condition, parameters: column_names, comment: <<~COMMENT
            ...
            def immutable_once_set table_name, column_names
              ...
              before_update table_name, name: :immutable_once_set, function_schema_name: :platformer, function_name: :validations_immutable_once_set, action_condition: action_condition, parameters: column_names, comment: <<~COMMENT
                Will call the function and raise an exception if any of the immutable columns have been updated,
