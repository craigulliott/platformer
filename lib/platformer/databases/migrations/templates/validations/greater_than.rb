module Platformer
  module Databases
    class Migrations
      module Templates
        module Validations
          class GreaterThan < DynamicMigrations::Postgres::Generator::ValidationTemplateBase
            DEFAULT_DESCRIPTION = <<~DESCRIPTION.strip
              This validation asserts that the column value is greater than the provided value
            DESCRIPTION
            ...
            def fragment_arguments
              ...
              options_string = name_and_description_options_string :"#{column_name}_gt", DEFAULT_DESCRIPTION
              {
                ...
                migration: <<~RUBY
                  validate_greater_than :#{validation.table.name}, :#{column_name}, #{value}#{options_string}
                RUBY
              }
            end
          end
