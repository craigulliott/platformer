...
RSpec.describe Platformer::Composers::ActiveRecord::Coercions::EmptyArrayToNullCoercions do
  ...
  describe "for a new UserModel which defines a simple new model with an array of chars field and trim and nullify coercion" do
    before(:each) do
      ...
      Platformer::Composers::ActiveRecord::Coercions::EmptyArrayToNullCoercions.rerun
    end
