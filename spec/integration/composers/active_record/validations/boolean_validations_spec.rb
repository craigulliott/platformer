...
RSpec.describe Platformer::Composers::ActiveRecord::Validations::BooleanValidations do
  ...
  describe "for a new UserModel which defines a simple new model with a boolean field which is validated to always being true" do
    before(:each) do
      ...
      Platformer::Composers::ActiveRecord::Validations::BooleanValidations.rerun
    end
