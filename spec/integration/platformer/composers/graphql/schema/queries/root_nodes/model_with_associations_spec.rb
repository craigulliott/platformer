    ...
    before(:each) do
      scaffold do
        ...
        model_for "Users::User" do
          ...
          primary_key
          has_many :user_hobbies, model: "Hobbies::UserHobbyModel"
          belongs_to :favorite_hobby, model: "Hobbies::HobbyModel"
          text_field :name
        ...
        model_for "Hobbies::UserHobby" do
          ...
          belongs_to :hobby, model: "Hobbies::HobbyModel"
        end
        model_for "Hobbies::Hobby" do
          ...
          primary_key
          has_many :user_hobbies, model: "Hobbies::UserHobbyModel"
          belongs_to :category, model: "Hobbies::CategoryModel"
          text_field :name
        end
        model_for "Hobbies::Category" do
          ...
          primary_key
          has_many :hobbies, model: "Hobbies::HobbyModel"
          text_field :name
        end
