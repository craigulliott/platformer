...
RSpec.describe Platformer::DatabaseDSLReader do
  describe "for a new UserModel which defines a simple new model and uses the database dsl" do
    ...
    let(:reader) { Platformer::DatabaseDSLReader.new Users::UserModel }
    let(:reader_with_database) { Platformer::DatabaseDSLReader.new Users::UserInSpecificDatabaseModel }
    let(:reader_without_schema) { Platformer::DatabaseDSLReader.new Users::UserWithoutSchemaModel }
